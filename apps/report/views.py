...
def export_excel(form_id):
    ...
    query = '{"source-table":60,"filter":["and",["=",["field",448,null],true],["=",["field",444,null],"Accepted"],'+f'["=",["field",779,null],{form_id}]]' + \
        ',"joins":[{"fields":[["field",142,{"join-alias":"Accounts User - User"}],["field",156,{"join-alias":"Accounts User - User"}],["field",158,{"join-alias":"Accounts User - User"}],["field",144,{"join-alias":"Accounts User - User"}],["field",159,{"join-alias":"Accounts User - User"}],["field",151,{"join-alias":"Accounts User - User"}],["field",146,{"join-alias":"Accounts User - User"}],["field",147,{"join-alias":"Accounts User - User"}]],"source-table":32,"condition":["=",["field",443,null],["field",151,{"join-alias":"Accounts User - User"}]],"alias":"Accounts User - User"}]},"type":"query","middleware":{"js-int-to-string?":true,"add-default-userland-constraints?":true}}'
    data = {
