...
from apps.widgets.serializers.content_widgets.content_widget_serializers\
    import BoxWidgetSerializer, TextWidgetSerializer, ImageSerializer, VideoSerializer, AparatSerializer, \
    IframeSerializer
...
class MockWidgetSerializer(serializers.Serializer):
    ...
    BoxWidgetSerializer = BoxWidgetSerializer(required=False)
