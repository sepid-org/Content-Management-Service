...
from apps.widgets.serializers.content_widgets.content_widget_serializers\
    import PlaceholderSerializer, TextWidgetSerializer, ImageSerializer, VideoSerializer, AparatSerializer, \
    IframeSerializer
...
class MockWidgetSerializer(serializers.Serializer):
    ...
    PlaceholderSerializer = PlaceholderSerializer(required=False)
